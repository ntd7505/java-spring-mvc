...
<style>
    /* 1) ép ảnh cùng chiều cao để không lệch hàng */
    .fruite-img {
        height: 190px;
        overflow: hidden;
    }
    ...
    /* 2) card cao bằng nhau trong mỗi hàng */
    .fruite-item {
        height: 100%;
        display: flex;
    ...
    /* 3) hạn chế mô tả dài làm card cao thấp */
    .fruite-item h4 {
        line-height: 1.3;
        min-height: 38px; /* ~2 dòng */
        overflow: hidden;
    }

    .fruite-item p {
        line-height: 1.35;
        min-height: 36px; /* ~2 dòng */
        overflow: hidden;
    ...
    /* 4) đẩy cụm giá + nút xuống đáy */
    .fruite-item .d-flex.flex-lg-wrap {
        margin-top: auto;
    }
</style>
                                        ...
                                        <div class="rounded position-relative fruite-item">
                                            ...
                                            <div
                                                ...
                                                <h4 style="font-size: 15px;">
                                                    <a href="/client/product/${product.id}">${product.name}</a>
                                                </h4>
