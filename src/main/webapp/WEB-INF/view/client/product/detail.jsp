            ...
            <div class="col-lg-8 col-xl-9">
                <div class="row g-4">
                    ...
                    <div class="col-lg-6">
                        ...
                        <h5 class="fw-bold mb-3"><p style="font-size: 15px; width: 100%;"
                        ...
                        <form action="/add-product-to-cart/${product.id}" method="post">
                            <input type="hidden" name="${_csrf.parameterName}"
                                   value="${_csrf.token}"/>
                            <input type="hidden" name="quantity" id="cartQuantityHidden" value="1"/>
                            <button
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-minus').click(function (e) {
            ...
            var quantityInput = $('#cartQuantityInput');
            var hiddenInput = $('#cartQuantityHidden');
            ...
            if (!isNaN(currentVal) && currentVal > 1) {
                ...
                hiddenInput.val(newVal); // Đồng bộ sang input ẩn để gửi server
            }
        });
